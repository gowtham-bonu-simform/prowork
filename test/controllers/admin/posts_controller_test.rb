...
class Admin::PostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'create a post' do
    assert_difference('Post.count') do
      post admin_posts_path, params: {post: {title: @post.title, months: @post.months, experience: @post.experience, hourly_rate: @post.hourly_rate, project_budget: @post.project_budget, description: @post.description, status: @post.status, skill_list: 'c , java'}}
    end
  ...
  test "can't create post with invalid data" do
    assert_no_difference('Post.count') do
      post admin_posts_path, params: {post: {skill_list: 'c, java'}}
    end
  end
  ...
  test 'update post' do
    post = posts(:post_one)
    patch admin_post_path(post), params: {post: {title: 'changed', skill_list: 'c, java'}}
    post.reload
  ...
  test "shouldn't update the product with invalid data" do
    post = posts(:post_one)
    patch admin_post_path(post), params: {post: {description: 'invalid description'}}
    post.reload
